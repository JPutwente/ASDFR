...
: ${AMENT_CURRENT_PREFIX:="/home/ram-user/ASDFR/src/ros2_nodes/src/install/jiwy_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/jiwy_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/jiwy_controller/environment/path.sh"
